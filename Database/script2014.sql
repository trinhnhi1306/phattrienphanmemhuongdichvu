USE [master]
GO
/****** Object:  Database [WEBSITE_VANPHONGPHAM]    Script Date: 1/29/2022 2:15:05 PM ******/
...
GO
/****** Object:  Table [dbo].[address]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[brand]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[cart]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[category]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[district]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[feedback]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[order]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[order_detail]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[order_status]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[permission]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[poster]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[product]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[province]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[users]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ward]    Script Date: 1/29/2022 2:15:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[address] ([address_id], [ward_id], [specific_address]) VALUES (38, 1, N'')
GO
...
GO
INSERT [dbo].[brand] ([brand_id], [name], [description]) VALUES (25, N'MiniStore 1', N'')
GO
SET IDENTITY_INSERT [dbo].[brand] OFF
GO
INSERT [dbo].[cart] ([product_id], [user_id], [quantity]) VALUES (3, 13, 1)
GO
INSERT [dbo].[cart] ([product_id], [user_id], [quantity]) VALUES (3, 14, 1)
GO
INSERT [dbo].[cart] ([product_id], [user_id], [quantity]) VALUES (3, 26, 5)
GO
INSERT [dbo].[cart] ([product_id], [user_id], [quantity]) VALUES (3, 37, 1)
GO
INSERT [dbo].[cart] ([product_id], [user_id], [quantity]) VALUES (4, 13, 1)
GO
...
GO
INSERT [dbo].[category] ([category_id], [name], [image], [note]) VALUES (33, N'Dụng cụ văn phòng phong cách cổ trang', N'211212220634bangKeoHoDan.png', N'')
GO
INSERT [dbo].[category] ([category_id], [name], [image], [note]) VALUES (44, N'Bút viết loại 3', N'defaul.png', N'')
GO
INSERT [dbo].[category] ([category_id], [name], [image], [note]) VALUES (45, N'Bút lông cổ trang loại 1', N'211212220726anVat.jpg', N'')
GO
...
GO
INSERT [dbo].[feedback] ([user_id], [product_id], [date], [comment], [vote]) VALUES (14, 2, CAST(N'2021-12-12' AS Date), N'Gút', NULL)
GO
...
GO
INSERT [dbo].[order] ([order_id], [date], [total_price], [status_id], [user_id]) VALUES (5, CAST(N'2021-11-18' AS Date), CAST(32920.00 AS Numeric(18, 2)), 4, 14)
GO
...
GO
INSERT [dbo].[order] ([order_id], [date], [total_price], [status_id], [user_id]) VALUES (26, CAST(N'2021-11-24' AS Date), CAST(24900.00 AS Numeric(18, 2)), 3, 13)
GO
...
GO
INSERT [dbo].[order] ([order_id], [date], [total_price], [status_id], [user_id]) VALUES (28, CAST(N'2021-12-11' AS Date), CAST(284482.00 AS Numeric(18, 2)), 3, 37)
GO
INSERT [dbo].[order] ([order_id], [date], [total_price], [status_id], [user_id]) VALUES (29, CAST(N'2021-12-12' AS Date), CAST(260100.00 AS Numeric(18, 2)), 2, 14)
GO
INSERT [dbo].[order] ([order_id], [date], [total_price], [status_id], [user_id]) VALUES (30, CAST(N'2021-12-13' AS Date), CAST(12600.00 AS Numeric(18, 2)), 1, 34)
GO
...
GO
INSERT [dbo].[order_detail] ([order_id], [product_id], [quantity], [item_price]) VALUES (29, 6, 3, CAST(40500.00 AS Numeric(18, 2)))
GO
INSERT [dbo].[order_detail] ([order_id], [product_id], [quantity], [item_price]) VALUES (29, 9, 1, CAST(138600.00 AS Numeric(18, 2)))
GO
INSERT [dbo].[order_detail] ([order_id], [product_id], [quantity], [item_price]) VALUES (30, 3, 1, CAST(4600.00 AS Numeric(18, 2)))
GO
INSERT [dbo].[order_detail] ([order_id], [product_id], [quantity], [item_price]) VALUES (30, 5, 1, CAST(7000.00 AS Numeric(18, 2)))
GO
INSERT [dbo].[order_detail] ([order_id], [product_id], [quantity], [item_price]) VALUES (30, 40, 1, CAST(1000.00 AS Numeric(18, 2)))
GO
...
GO
INSERT [dbo].[poster] ([id], [name], [type], [isActive]) VALUES (5, N'211212214934211210164933poster13.jpg', 1, 1)
GO
INSERT [dbo].[poster] ([id], [name], [type], [isActive]) VALUES (6, N'211212215449poster1.jpg', 2, 1)
GO
...
Không độc hại, tiện dụng khi sử dụng.
 Mực hệ nước, hệ màu dye.', N'fo-gel18_vn_tim_71669d93f8d04bf498bbf73b7ab162e5_1024x1024.jpg                                                                                                                                                                                                                                              ', CAST(8300.00 AS Numeric(18, 2)), N'1 bút/ kiện.', N'cây', 0, 4, 30, 1, 16, 1)
GO
...
GO
INSERT [dbo].[product] ([product_id], [name], [description], [image], [price], [specification], [calculation_unit], [discount], [sold_quantity], [quantity], [category_id], [brand_id], [status]) VALUES (37, N'test 1', N'Sổ cổ trang', N'211212220018211122213805voCoTrang.jpg', CAST(1000.00 AS Numeric(18, 2)), N'bút/kiện', N'cái', 5, 5, 15, 1, 1, 1)
GO
...
GO
INSERT [dbo].[product] ([product_id], [name], [description], [image], [price], [specification], [calculation_unit], [discount], [sold_quantity], [quantity], [category_id], [brand_id], [status]) VALUES (39, N'Kẹp sách cổ trang', N'Kẹp sách xinh đẹp', N'211212220353211122215900bookmarkCTKL.jpg', CAST(20000.00 AS Numeric(18, 2)), N'5 tấm/1 set', N'set', NULL, 0, 30, 33, 9, 1)
GO
INSERT [dbo].[product] ([product_id], [name], [description], [image], [price], [specification], [calculation_unit], [discount], [sold_quantity], [quantity], [category_id], [brand_id], [status]) VALUES (40, N'test 6', N'abc', N'default.png', CAST(1000.00 AS Numeric(18, 2)), N'bút/kiện', N'hộp', 0, 0, 30, 1, 1, 1)
GO
...
GO
INSERT [dbo].[users] ([user_id], [username], [password], [first_name], [last_name], [image], [address_id], [email], [phone], [created_at], [permission_id], [status]) VALUES (11, N'reintrinh1306', N'$2a$12$Gnsnbj7PCpH0xi/9uwVefeNf2cNxVvRiTCktcCj.9IolJuEua3Q/m', N'Trinh', N'Nguyễn Ngọc Phương', N'resources/images/users/211211185414avatar.jpg', 1, N'reintrinh1306@gmail.com', N'0396311734', CAST(N'2021-10-02' AS Date), 2, 1)
GO
...
GO
INSERT [dbo].[users] ([user_id], [username], [password], [first_name], [last_name], [image], [address_id], [email], [phone], [created_at], [permission_id], [status]) VALUES (14, N'trinhnguyen1306', N'$2a$12$CRplfBh93aNaNPna2CUxpO8n5E3qcgcDdSFuDPIfqGEN07Od92G1G', N'Trinh', N'Nguyễn', N'resources/images/users/star.png', 4, N'otakuvocaloid70@gmail.com', N'0123456789', CAST(N'2021-11-20' AS Date), 1, 1)
GO
...
GO
INSERT [dbo].[users] ([user_id], [username], [password], [first_name], [last_name], [image], [address_id], [email], [phone], [created_at], [permission_id], [status]) VALUES (39, N'abc3', N'$2a$12$E/bsx.HRvgkxyV61ES2/qup37.fhPv6Tn07YetaDnwymHhwChzgMy', N'abc', N'Nguyễn', N'resources/images/users/211212221712agenda.png', 38, N'otakuvocaloid71@gmail.com', N'0396311700', CAST(N'2021-12-12' AS Date), 1, 1)
GO
INSERT [dbo].[users] ([user_id], [username], [password], [first_name], [last_name], [image], [address_id], [email], [phone], [created_at], [permission_id], [status]) VALUES (40, N'hellokitty', N'$2a$12$dIn734jVa2BDVSFvWdDFcuB7EXU9KWFbHVuJzfKHnSXeo9nIDKim2', N'Kitty', N'Hello', N'resources/images/users/userDefaul.png', 40, N'hello@gmail.com', N'0000000099', CAST(N'2021-12-13' AS Date), 1, 1)
GO
